"""
Phase 72b: TRANSFER. The V*Bench-trained re-ranking head, applied to HR-Bench 4k, nothing refitted.
...
OUT = "/home/kavinder/ARNABI_ARSH/vlm-hallu/data/phase72b_hrbench_transfer.jsonl"
...
def main():
    ...
    with open(OUT, "a") as fout:
        for inst, grp in df.groupby("_inst"):
            ...
            hcell, acell, ncell = propose(img, rows[0]["question"])
