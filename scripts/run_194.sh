...
until grep -q R193_DONE logs/run_193.log 2>/dev/null; do sleep 60; done
...
run 14000 q_194_qwen3 scripts/phase194_funded_multicrop.py qwen3
run 30000 q_194_qwen2 scripts/phase194_funded_multicrop.py qwen2
echo R194_DONE
