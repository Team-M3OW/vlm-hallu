...
run 22000 q_184_qwen2 scripts/phase184_allarms.py qwen2      # the contested model first
run  9000 q_184_qwen3 scripts/phase184_allarms.py qwen3
echo ALLARMS_QUEUE_DONE
