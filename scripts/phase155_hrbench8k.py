"""
Phase 155 (reviewer W3/W6): HR-Bench 8K, a third benchmark at n=800, Qwen3-VL-2B head zero-shot, full-prompt localiser, W=0.15. Original header follows.
...
OUT = "/home/kavinder/ARNABI_ARSH/vlm-hallu/data/phase155_hrbench8k_qwen3.jsonl"
...
def main():
    ...
    p = hf_hub_download("DreamMr/HR-Bench", "hr_bench_8k.parquet", repo_type="dataset")
    ...
    with open(OUT, "a") as fout:
        for inst, grp in df.groupby("_inst"):
            ...
            hcell, acell, ncell = propose(img, prompt(rows[0]))
            ...
            for r in rows:
                ...
                rec = {"row_id": int(r["index"]), "instance": int(inst),
                       ...
                       "head_cell": list(hcell), "argmax_cell": list(acell),
