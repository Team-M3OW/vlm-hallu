...
OUT=f"{D}/data/phase185b_diag_{WHICH}.jsonl"; NL=28; P=16; Image.MAX_IMAGE_PIXELS=None
# 185b DIAGNOSTIC (over-budget arms, not eligible as the method): decompose TSR's gain into resolution vs pruning.
#   uniform@900 = same encoding, NO pruning (25,200 TL) ; tsr900_k25 = milder pruning ; prune600_L16_k10 = tsr600 (re-run for pairing)
ARMS={"tsr900":(900,16,0.10,"win"),"tsr900_k25":(900,16,0.25,"win"),"tsr900_k50":(900,16,0.50,"win"),"uniform900_prune_L24_k10":(900,24,0.10,"win")}
def make_patched(QM):
