"""
Phase 93b: CROSSING THE TWO AXES. Qwen2-VL-7B on POPE + MMBench.

SS14L/SS14L(b) hold on two models but only on V*Bench. SS14P holds on three benchmarks but only on
Qwen3-VL. No claim in this project has ever been replicated across models AND benchmarks together.
This crosses the strongest one. Block rescaled to the same fraction of the stack (L15-26 of 28).
...
OUT = "/home/kavinder/ARNABI_ARSH/vlm-hallu/data/phase93b_pruning_general_qwen2.jsonl"
BLOCK, FASTV_K, B0, KEEP, N_PER = list(range(15, 27)), 2, 300, 0.10, 200  # L15-26 of 28: same stack fraction as Qwen3-VL L16-26
