...
\begin{table}[t]
\caption{AVR on HR-Bench. Gain over the equal-compute reference, the measured resolution headroom ($\mathrm{acc}_{900}-\mathrm{acc}_{600}$), and the pruning cost (AVR $-$ \texttt{uniform@900}).}
\label{tab:avrhr}
\begin{center}
\small
\begin{tabular}{llccc}
\multicolumn{1}{c}{\bf cell} &\multicolumn{1}{c}{\bf stratum} &\multicolumn{1}{c}{\bf AVR $-$ reference} &\multicolumn{1}{c}{\bf headroom} &\multicolumn{1}{c}{\bf pruning cost}
\\ \hline \\
