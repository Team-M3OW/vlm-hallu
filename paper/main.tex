...
We state two theorems, four propositions and two lemmas. They are not deep results --- one theorem is a tail-dominance
argument and the lemmas are one-line linear algebra --- but each makes a prediction that could have failed on data,
and we report where they hold approximately rather than exactly. All measurements are out-of-fold on both core
...
\begin{proposition}[Post-boundary inertness makes pruning free, and makes AVR a resolution converter]\label{prop:avr}
...
\end{proposition}
\begin{proof}
The premise equates the option distributions of the pruned and unpruned models; subtracting the bar's accuracy gives
the gain statement.
\end{proof}
